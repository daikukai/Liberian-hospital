    ...
    <div class="tp-banner-container">
      <div class="tp-banner">
        <ul>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            <!-- MAIN IMAGE --> 
            <img src="images/hms1.jpg"  alt="slider"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
            ...
            <div class="tp-caption sfb tp-resizeme" 
                ...
                data-endspeed="300" 
                data-scrolloffset="0"
                style="z-index: 6; font-size:40px; color:#000; font-weight:500; white-space: nowrap;"> Welcome To Our State of the Art Facility </div>
              ...
              <div class="text-sec">
                ...
                <ul class="row">
                  <li class="col-sm-6">
                    ...
                    <p>We attend to avariety of emergencies, such as fatal accidents, Burn, Poisen, Knife wound and etc.  <var></var> </p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> Qualified Doctors</h6>
                    <p>Our medical staff are exception, professional healthcare worker from diverse educational background from europe, and the americas. </p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> Online Appointement</h6>
                    <p>We care for our patient therefore we also make available to them an online platform to make your appointments easy and accessible to meet with doctors at your convenience. </p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> Free Medical Counseling</h6>
                    <p>At our facility we offer counseling for our patient free of charge. Some counseling we ofer are AIDS, Marital, Gender Based Violence counseling. </p>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <hr>
              ...
              <div class="timing"> <i class="lnr lnr-clock"></i>
                ...
                <ul>
                  ...
                  <li> Sunday <span>8:00 - 4:00</span></li>
                </ul>
              </div>
            </div>
          </div>
    ...
    <section class="p-t-b-150">
      <div class="container"> 
        ...
        <div class="heading-block">
          <h2>Our Services</h2>
          <hr>
          <span>We provide the following services to our customers with love and respect.</span> </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  <h6>Eye Treatmenty</h6>
                  <p>Eye is the light on the body, so we diagnose, test, treat, and offer glasses and many other treatment that is needed for the eye.</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>At this facility we do major surgery in our theater.</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>Handling critical emergency needs a critical unit, therefore our ICU is ready for your emergency.</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>Doctors also pay attention to minor illness like malaria, typhoid, and other diseases in our  OPD.</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>At this hospital we diagnose/test heart  related problems and recommend a treatment center.</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>We treat olser, growth, stomach pain and many other stomach problems you may encounter.</p>
                </div>
              </article>
            </div>
          </div>
